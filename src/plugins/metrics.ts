...
export interface MetricsRegistry {
  registry: Registry;
  otpSent: Counter<string>;
  otpVerified: Counter<string>;
  smsSent: Counter<string>;
  smsErrors: Counter<string>;
  rateLimitBlocks: Counter<string>;
  otpSendDuration: Histogram<string>;
  smsProviderLatency: Histogram<string>;
  queueWait: Histogram<string>;
}
...
export default fp(
  async (app) => {
    if (!app.env.METRICS_ENABLED) return;
